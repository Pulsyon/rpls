...
- Fork ID parity is not implemented yet.

## Verification

- Unit tests cover CLI help chain visibility, default bootnode injection, Pulse DNS discovery links, and default RPC transaction fee cap handling.
